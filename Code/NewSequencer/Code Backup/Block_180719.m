classdef Block < matlab.mixin.CustomDisplay &handle
    ...
    properties
        b
        name
        atomic={'set776ControlPower','setProbePower','setImagingDetuning','setImagingPower','setRepumpPower','setCoolingPower','setCoolingDetuning','setRepumpDetuning','pause',...
            'setDigitalChannel','setAnalogChannel','GenPause','startAnalogRamp','setCircCurrent'...
            ,'startCoolingPowerRamp','forEnd'};
        compound={'forStart','syncSetProbeLockFreq','syncSetProbeAOMFreq','probeAOMTriangularScan','TakeAbsPic','TrigScope','TakePicForMWSpectro','Load MOT'...
        ...
        async={'startTTrawShort','startTTraw','startTTcorrelation','startTTgatedCount','setProbeDetuning','SetMWFreq'...
            ...
            ,'setRigolDC','setRigolGateMode','setCamExp','setRigolBurstMode','setRigolBurstState'};        
    end
                ...
                switch action{1}
                    case 'Load MOT'
                        atomizedAction={
                            ...
                            {'setDigitalChannel','channel','coolingZShutter','duration',0,'value','high','description','Load MOT:open z shutter'};...
