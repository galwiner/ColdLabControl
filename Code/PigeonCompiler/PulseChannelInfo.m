...
if isempty(info)
    info={
        ...
        struct('ChannelName','AO5','ChannelType','Analog','AnalogSwitch',5),...
        struct('ChannelName','AO6','ChannelType','Analog','AnalogSwitch',6),...
        struct('ChannelName','AO7','ChannelType','Analog','AnalogSwitch',7)
