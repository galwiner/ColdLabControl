function [TTmatFileName]=getTtMatFileName(binFilename)
global p 
if nargin==0
...
%         fprintf('next file num = %d\n',file_num+1);
        TTmatFileName=sprintf([r{1} '_' r{2} '_%02d__' exp_name '.mat'],file_num);
...
if strcmpi(next_file_name,'')
    ...
    TTmatFileName=['tt_' file_base '_01__' expname '.mat'];
end

else
    [path,filename,ext]=fileparts(binFileName);
    TTmatFileName=[filename '.mat'];
