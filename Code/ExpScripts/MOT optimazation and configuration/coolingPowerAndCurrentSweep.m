...
initinst
initr
p.expName = 'cooling power and current sweep';
p.NAverage = 2;
p.loopVars = {'coolingPower','circCurrent'};
coolingPowerVals=linspace(200,690,3);
circCurrentVals = linspace(10,60,3);
p.loopVals={coolingPowerVals,circCurrentVals};
...
imagesc(p.loopVals{1},grads,squeeze(r.atomNum{1}))
title('Atom number')
