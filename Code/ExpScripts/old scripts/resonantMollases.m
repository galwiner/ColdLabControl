%L.D. & GW 061217
%resonant mollases for beam aligning
...
params.delayList=[300,400,1000,1200,1500]; %times for the TOF flights in microseconds
...
for ind=1:length(delay)
    ...
    seqUpload(horzcat(resMollassesSeq(channelTable,0,delay(ind)),...
