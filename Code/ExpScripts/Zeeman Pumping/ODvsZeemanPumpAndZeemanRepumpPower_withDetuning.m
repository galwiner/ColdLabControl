...
loadNoise;
p.expName = 'OD vs zeemanPump and zeemanRepump power with zeeman pump off resonant';
%%
%ramp settings and setup
p.notificationOn = 1;
p.s = sqncr;
p.s.addBlock({p.asyncActions.setZeemanRepumpDetuning,'value',p.zeemanDetuning});
