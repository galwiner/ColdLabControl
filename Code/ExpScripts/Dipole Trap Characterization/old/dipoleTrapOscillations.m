...
p.s.addBlock({'Release MOT'});
p.s.addBlock({'pause','duration',40e3});
p.s.addBlock({'setDigitalChannel','channel','BlueDTSwitch','duration',1e3,'value','low','inverted','true'});
p.s.addBlock({'setDigitalChannel','channel','PurpleDTSwitch','duration',1e3,'value','low','inverted','true'});
