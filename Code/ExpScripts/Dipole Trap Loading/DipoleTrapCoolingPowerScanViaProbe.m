...
p.expName = 'DipoleTrapCoolingPowerScanViaProbe';
%%
...
p.DepumpTime = 400;
p.TOFTime = 1;
% p.loopVals{1} = [linspace(1,50,10),100:50:350];
p.loopVals{1} = linspace(20,60,10);
...
%
OD = getODFromProbeScan(r,p);
figure;
plot(p.loopVals{1},OD)
