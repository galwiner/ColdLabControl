...
p.looping=1;
p.expName = 'AligneProbeOnDipoleTrap';
%%
% inst.DDS.setFreq(1,63,0,0);
% pause(0.3)
p.repumpTime = 1;
p.MOTReleaseTime = 300;
p.DTParams.TrapTime = 0.01e4;
...
% plot(ax1,Upfreq*2,UpData./max(UpData),'linewidth',2)
% plot(ax2,fliplr(Downfreq*2),DownData./max(DownData),'linewidth',2)
