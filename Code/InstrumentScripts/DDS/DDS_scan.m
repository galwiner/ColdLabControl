function DDS_scan(span,time,center,channel,multiplyer)
...
switch channel
    case 1
        ...
        pause(1);
        DRG_LAB_1(UP_FREQUENCY,DOWN_FREQUENCY,dtP,dtN,dfP,dfN);
    case 2
        SHU2_initial_2016(1,0,1);
        pause(1);
        DRG_LAB_2(UP_FREQUENCY,DOWN_FREQUENCY,dtP,dtN,dfP,dfN);
    case 3
        SHU3_initial_2016(1,0,1);
        pause(1);
        DRG_LAB_3(UP_FREQUENCY,DOWN_FREQUENCY,dtP,dtN,dfP,dfN);
    case 4
        SHU4_initial_2016(1,0,1);
        pause(1);
        DRG_LAB_4(UP_FREQUENCY,DOWN_FREQUENCY,dtP,dtN,dfP,dfN);
    otherwise
