function [ output_args ] = SHOVACH_INIT_1(obj,DRG,Singlemode,REF1)



% obj.s = serial('COM16','BaudRate',9600,'DataBits',8);
...
fwrite(obj.s,SYNC_address);
fwrite(obj.s,SYNC_24_31);
fwrite(obj.s,SYNC_16_23);
fwrite(obj.s,SYNC_8_15);
fwrite(obj.s,SYNC_0_7);
