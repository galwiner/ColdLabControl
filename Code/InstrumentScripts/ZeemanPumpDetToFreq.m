function freq = ZeemanPumpDetToFreq(det,multiplier)
if nargin==1
    multiplier=1;
end
...
Resonant_freq = Resonant_freq-72.9; %F'=3 in the upper manifold is shifted up
AOM_shift=-200; %Single pass AOM at 200 MHz order -1.
