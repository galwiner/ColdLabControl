 function AO = ProbePower2AO_withND(powerOnAtoms,ND_list)
%g.w  13.2.19
%power in mW
global p
...
if powerOnAtoms>maxp*1e-6 || powerOnAtoms<minp*1e-6
    error('required power is %.2d nW. At this ND setting power on atoms must be between %0.2d nW and %0.2d nW!',powerOnAtoms*1e6,minp,maxp)
end
